...
import com.bookshop.vo.ProductListVo;
...
public class ProductService implements IProductService{
    ...
    @Override
    public ServerResponse saveOrUpdateProduct(ProductWithBLOBs product) {
        if (product != null){
            //将上传的第一张产品图片作为主图
            ...
            if (product.getId() != null){
                int resultCount = productMapper.updateByPrimaryKeyWithBLOBs(product);
                if (resultCount > 0){
